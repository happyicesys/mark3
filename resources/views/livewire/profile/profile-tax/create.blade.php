<div>
    <form wire:submit.prevent="save()">
        <x-modal.dialog wire:model="showCreateProfileTaxModal" maxWidth="4xl" id="profile-tax-create">
            <x-slot name="title">
                <div class="">
                    <div>
            ...
            <x-slot name="content">
                <div class="md:m-4 my-4 py-4 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    ...
                    <x-button.create type="button" wire:model.prevent="createTaxProfile({{ isset($profileForm) ? $profileForm->id : null }})">
                        Create
                    </x-button.create>
                    </div>
                            ...
                            <tbody class="bg-white">
                                ...
                                <tr class="divide-x divide-gray-200" wire:key="tax-{{$profileTax->id}}">
                                    <x-table.td class="text-center">
                                        {{ $profileTaxes->firstItem() + $profileTax }}
                                    </x-table.td>
                                    ...
                                    <x-table.td class="text-center">
                                        {{ $profileTax->is_default_inclusive }}
                                    </x-table.td>
                                    <x-table.td class="text-center">
                                        {{-- <x-button
